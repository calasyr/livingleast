...
class CommunicationsControllerTest < ActionController::TestCase
  ...
  test "should create communication" do
    assert_difference('Communication.count') do
      post :create, communication: { message: @communication.message, purchase_id: @communication.purchase_id, to_id: @communication.to_id, user_id: @communication.user_id }
    end
  ...
  test "should update communication" do
    put :update, id: @communication, communication: { message: @communication.message, purchase_id: @communication.purchase_id, to_id: @communication.to_id, user_id: @communication.user_id }
    assert_redirected_to communication_path(assigns(:communication))
  end
